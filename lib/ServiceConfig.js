...
/**
 * Returns lazily cached APIGateway client.
 * @return {APIGateway} Cached client instance.
 */
...
/**
 * Returns namespaced global cache to avoid collision.
 * @return {{ serviceMap: object, apiKeyCache: object }} Global cache object.
 */
...
/**
 * Transforms request when data.logo is a file path.
 * @param {object} data - Request data potentially containing a logo path.
 * @param {object} config - Axios config to merge content-type into.
 * @return {{ data: object, config: object }} Transformed request.
 */
